...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
            <ul class="pager">
                <g:if test="${hasPrev}"><li class="previous"><a
                        href="${createLink(action: "show", params: [blogid: blog.getId() - 1])}">&larr; Предыдущая</a>
                </li></g:if>
                <g:if test="${hasNext}"><li class="next"><a
                        href="${createLink(action: "show", params: [blogid: blog.getId() + 1])}">Следующая &rarr;</a>
                </li></g:if>
            </ul>
        </div>
    </div>
